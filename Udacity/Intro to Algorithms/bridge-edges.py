# Bridge Edges v4
# non-tree edges - edges between nodes already 
# exsistent in the graph

# black - postnumber, greates postnumber of 
#         children + 1
# blue  - number of descendants + 1
# red   - smallest postnumber of any descendant and/or
